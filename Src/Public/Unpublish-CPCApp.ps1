function Unpublish-CloudApp{
    ...
    .EXAMPLE
    Unpublish-CloudApp -Id "c1a2b3d4-e5f6-7g8h-9i0j-k1l2m3n4o5p6"

    .EXAMPLE
    Unpublish-CloudApp -Name "Microsoft Access"

    .EXAMPLE
    Get-CloudApp -Name "Access" | Unpublish-CloudApp
    
    .EXAMPLE
    Get-CloudApp | Where-Object { $_.appStatus -eq "published" } | Unpublish-CloudApp
    #>
